...
import Dashboard from "./Admin"; // Assuming it's a frontend component
...
import AdminNavbar from "../Navigation/AdminNavbar"; // Assuming this is a frontend navigation component
    ...
    <ThemeProvider theme={customTheme}>
      <Box sx={{ display: `${isLargeScreen ? "flex" : "block"}` }}>
        ...
        <Box component="main" sx={{ flexGrow: 1 }}>
          <Toolbar />
          <Dashboard /> {/* Rendering the main content */}
        </Box>
      </Box>
    </ThemeProvider>
  );
