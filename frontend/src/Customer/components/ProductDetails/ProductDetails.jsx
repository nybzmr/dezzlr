  ...
  return (
    <div className="bg-white text-left">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          {/* Image gallery */}
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6 ">
                ...
                <div className="flex items-center">
                  <p className="opacity-50 text-sm ">2386 Ratings</p>
        ...
        {/* rating and reviews */}
        <section>
          <h1 className="font-semibold text-2xl pb-4 mx-20 my-5">
            ...
            <Grid container spacing={7}>
              ...
              <Grid  item xs={4}>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="opacity-60">5409 Ratings</p>
                </div>
